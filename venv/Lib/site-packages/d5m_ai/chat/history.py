...
def _create_ssl_context() -> ssl.SSLContext:
    try:
        ...
        logging.warning(f"[CHAT-HISTORY] Failed to use certifi CA bundle: {e}, using default SSL context")
...
class AIChatHistoryHandler(APIHandler):
    ...
    async def post(self):
        ...
        try:
            ...
            try:
                ...
                logging.warning(f"[CHAT-HISTORY] Failed to schedule remote backup: {e}")
        except Exception as e:
            self.set_status(500)
            self.finish(json.dumps({"error": str(e), "status": "error"}))
    ...
    async def _backup_history_remote(self, history: Dict[str, Any]):
        ...
        try:
            ...
            logging.warning("[CHAT-HISTORY] Remote backup exception: %s", e)

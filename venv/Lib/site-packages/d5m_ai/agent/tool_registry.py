...
class AgentToolMeta:
    ...
    frontend_timeout_seconds: Optional[float] = None  # timeout for frontend response
...
AGENT_TOOL_REGISTRY: Dict[str, AgentToolMeta] = {
    ...
    "cell_execute": AgentToolMeta(
        ...
        frontend_timeout_seconds=90.0,
        frontend_error="Error: frontend WebSocket is not connected; cannot execute cell.",
    ),
